...
namespace Mystic
{
    public partial class RunsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // Account deactivated due to billing. Please add a payment method.
            ...
            // Permission denied (for example, accessing a pipeline that is owned by another user)
            ...
            // This pipeline is currently starting up. This is normal behaviour for pipelines that are new or have not been run in a while. Please wait a few minutes before next run.
            ...
            else
            {
                ...
                var __responseValue = await global::Mystic.ClusterRunResult.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
        ...
        public async global::System.Threading.Tasks.Task<global::Mystic.ClusterRunResult> SubmitRunAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Mystic.RunCreate
            {
                Pipeline = pipeline,
                Inputs = inputs,
                AsyncRun = asyncRun,
