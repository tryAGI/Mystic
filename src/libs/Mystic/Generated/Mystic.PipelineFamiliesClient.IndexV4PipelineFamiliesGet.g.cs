...
namespace Mystic
{
    ...
    {
        partial void PrepareIndexV4PipelineFamiliesGetArguments(
            ...
            ref int skip,
            ref int limit);
        partial void PrepareIndexV4PipelineFamiliesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int skip,
            int limit);
        partial void ProcessIndexV4PipelineFamiliesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessIndexV4PipelineFamiliesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Mystic.PaginatedPipelineFamilyGet> IndexV4PipelineFamiliesGetAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: _httpClient);
            PrepareIndexV4PipelineFamiliesGetArguments(
            ...
            PrepareRequest(
                client: _httpClient,
                request: httpRequest);
            PrepareIndexV4PipelineFamiliesGetRequest(
                httpClient: _httpClient,
            ...
            ProcessResponse(
                client: _httpClient,
                response: response);
            ProcessIndexV4PipelineFamiliesGetResponse(
                httpClient: _httpClient,
            ...
            ProcessIndexV4PipelineFamiliesGetResponseContent(
                httpClient: _httpClient,
                httpResponseMessage: response,
                content: ref __content);
            ...
            return
                global::System.Text.Json.JsonSerializer.Deserialize(__content, global::Mystic.SourceGenerationContext.Default.PaginatedPipelineFamilyGet) ??
